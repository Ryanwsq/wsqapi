...
export async function getLoginUserUsingGETX(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserVO>('/api/user/get/logins', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function updateUserCredentials(
  ...
  return request<API.BaseResponseboolean>('/api/user/certificate', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
